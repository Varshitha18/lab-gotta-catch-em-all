...
public class PokemonController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (value1 != null) {
			...
			Bulbasaur b = new Bulbasaur("Bulbasaur", 001, "Bulbasaur is a Grass/Poison-type Pok�mon introduced in Generation I. It evolves into Ivysaur starting at level 16. It is one of the three Starter Pok�mon in the Kanto region", "POISON", "IVYSAUR", "64");
